...
describe('stringCalculator', () => {
  ...
  it('returns a number given a string containing a single number', () => {
    const result = stringCalculator('123');

    expect(result).toBe(123);
  });

  it('returns the sum of the numbers given a string containing several numbers separated by commas', () => {
    const result = stringCalculator('1,2,3');

    expect(result).toBe(6);
  });

  it('ignores no numeric elements', () => {
    const result = stringCalculator('1,b,3');

    expect(result).toBe(4);
  });

  it('returns 0 given only no numeric elements', () => {
  ...
  it('ignores commas if custom separators are provided', () => {
